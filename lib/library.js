...
export async function buildLibrary({ homeDir, packageRoot }) {
  ...
  // both before it loads anything: calibration to stand her on the floor, and the
  ...
  // canvas. That box becomes her interactive area; without it a click anywhere in
  // the transparent margin would count as touching her.
  let placements = null;
